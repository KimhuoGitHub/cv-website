      ...
      <div className="languages-list">
        {languages.map((lang, index) => (
          <div key={index} className="language-item">
            ...
            <div className="language-bar" role="progressbar" aria-label={`${lang.name} proficiency`} aria-valuenow={getProficiencyValue(lang.proficiency)} aria-valuemin="0" aria-valuemax="100">
              <div
                className="language-bar-fill"
                style={{ width: `${getProficiencyValue(lang.proficiency)}%` }}
              />
            </div>
          </div>
        ))}
...
// Helper function to convert proficiency text to percentage
const getProficiencyValue = (proficiency) => {
  const proficiencyMap = {
    ...
    'Professional': 80,
    'Full Professional Proficiency': 90,
