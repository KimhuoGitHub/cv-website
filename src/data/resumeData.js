export const personalInfo = {
	...
	github: 'https://github.com/KimhuoGitHub/kimhuo-dev', // Add your GitHub URL if you have one
	portfolio: 'https://kimhuo-dev.web.app/', // Add portfolio URL if you have one
};
...
export const education = [
	{
		...
		description:
			'Software Development Skills, Training Center, IT Expert School (Scholarship Student)',
	},
	{
		...
		description:
			'Information Technology, Computer Programming, Software Development Skills',
	},
];
...
export const certifications = [
	{
		...
		description:
			'Advanced Course (608 hours): React JS, React Native, Redux Pattern, Mobile Programming, UI Kits, Git, App Deployment',
	},
	{
		...
		description:
			'Basic Course (800 hours): Java (J2SE, J2EE), Spring Boot, PostgreSQL, HTML/CSS/JavaScript, RESTful APIs',
	},
	{
...
export const projects = [
	{
		...
		description:
			'Real estate property listing mobile app built with React Native. Implemented map view integration, advanced filtering, authentication flows, and term management. Full-stack development with REST API integration.',
		technologies: [
			'React Native',
			'Redux',
			'Google Maps API',
	...
	},
	{
		...
		description:
			'E-commerce web platform for property listings. Developed product and category management system at backend, implemented responsive UI components, and handled full-stack development.',
		technologies: [
			'React JS',
			'Spring Boot',
			'PostgreSQL',
	...
	},
	{
		...
		description:
			"Enterprise-level sales and inventory management system. Bachelor's thesis project involving system analysis, architecture design, and full implementation with documentation.",
		technologies: [
			'Java',
			'Spring Framework',
			'MySQL',
